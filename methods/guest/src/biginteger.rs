    ...
    ($name:ident, $num_limbs:expr) => {
        ...
        impl BigInteger for $name {
            ...
            fn add_nocarry(&mut self, other: &Self) -> bool {
                ...
                for i in 0..$num_limbs {
                    ...
                    unsafe {
                        ...
                        carry = _addcarry_u32(carry, self.0[i], other.0[i], &mut self.0[i])
                    };
            ...
            fn sub_noborrow(&mut self, other: &Self) -> bool {
                ...
                for i in 0..$num_limbs {
                    ...
                    unsafe {
                        ...
                        borrow = _subborrow_u32(borrow, self.0[i], other.0[i], &mut self.0[i])
                    };
            ...
            fn mul2(&mut self) {
                ...
                #[allow(unsafe_code)]
                {
                    ...
                    for i in 0..$num_limbs {
                        unsafe {
                            use core::arch::x86_64::_addcarry_u32;
                            carry = _addcarry_u32(carry, self.0[i], self.0[i], &mut self.0[i])
                        };
                    }
                }
            ...
            fn from_bits_be(bits: &[bool]) -> Self {
                ...
                bits.reverse();
                for (i, bits64) in bits.chunks(32).enumerate() {
            ...
            fn to_bytes_le(&self) -> Vec<u8> {
                ...
                let mut res = Vec::<u8>::with_capacity($num_limbs * 4);
            ...
            fn try_from(val: num_bigint::BigUint) -> Result<$name, Self::Error> {
                ...
                if bytes.len() > $num_limbs * 4 {
                    ...
                    bytes
                        ...
                        .enumerate()
                        .for_each(|(i, chunk)| {
                            let mut chunk_padded = [0u8; 4];
                            chunk_padded[..chunk.len()].copy_from_slice(chunk);
                            limbs[i] = u32::from_le_bytes(chunk_padded)
                        });
...
bigint_impl!(BigInteger256_32, 8);
